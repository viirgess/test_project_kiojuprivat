...
class RateDetailViewMobile extends StatelessWidget {
  const RateDetailViewMobile({super.key, required this.rate});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PrimaryAppBar(title: '${rate.code} – ${context.l10n.rateHistory}'),
      body: BlocBuilder<RateHistoryBloc, RateHistoryState>(
